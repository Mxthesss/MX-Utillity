	...
	if not carry.InProgress then
		...
		if closestPlayer then
			...
			if targetSrc ~= -1 then
				...
				TriggerServerEvent("MX-CarryPeople:sync",targetSrc)
		...
		TriggerServerEvent("MX-CarryPeople:stop",carry.targetSrc)
		carry.targetSrc = 0
	end
end,false)

RegisterNetEvent("MX-CarryPeople:syncTarget")
AddEventHandler("MX-CarryPeople:syncTarget", function(targetSrc)
...
RegisterNetEvent("MX-CarryPeople:cl_stop")
AddEventHandler("MX-CarryPeople:cl_stop", function()
	carry.InProgress = false
	ClearPedSecondaryTask(PlayerPedId())
	DetachEntity(PlayerPedId(), true, false)
end)
